...
# 494가 아니라 493이다.
#
# 원자료의 분류별 N 표기를 더하면 494인데, 같은 표에 실제로 나열된 성분은
# 493개다. 세 분류에서 표기와 나열이 어긋난다.
#
#   Antidepressants        N=20  나열 19
#   Antipsychotics         N=25  나열 24
#   Mineral and vitamins   N=15  나열 16
#
# 우리가 적재한 493개는 나열된 성분과 이름 단위까지 전부 일치한다(분류별
# 차집합 0). 적재에서 흘린 것이 아니라 원자료의 표기가 자기 목록과 맞지
# 않는다. 화면에는 실제로 대조 가능한 수인 493을 쓴다.
